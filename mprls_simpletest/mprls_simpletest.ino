...
// wdv: First install library Adafruit MPRLS (e.g. 1.0.3)
...
void loop() {
  ...
  float temp_K = 273.15 + 5.0;
  float height_m = 29.0;
  Serial.print("Pressure0 (hPa): "); Serial.println(pressure_hPa / exp(-0.0288*9.81*height_m/(8.3144621*temp_K)));
